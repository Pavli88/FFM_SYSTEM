...
CREATE TABLE `strategy` (
  `strategy_code` int(11) NOT NULL,
  `strategy_name` varchar(45) DEFAULT NULL,
  `strategy_desc` longtext,
  `start_date` date DEFAULT NULL,
  `end_date` date DEFAULT NULL,
  `strat_modell_code` int(11) DEFAULT NULL,
  `portfolio_code` int(11) DEFAULT NULL,
  `strategy_type` varchar(45) DEFAULT NULL,
  `trade_margin` float DEFAULT NULL,
