...
--
-- Table structure for table `portfolio_return`
--

DROP TABLE IF EXISTS `portfolio_return`;
...
CREATE TABLE `portfolio_return` (
  ...
  `price_return` float DEFAULT NULL,
  `trade_return` float DEFAULT NULL,
  `total_return` float DEFAULT NULL,
  `realized_pnl` float DEFAULT NULL,
  `floating_pnl` float DEFAULT NULL,
